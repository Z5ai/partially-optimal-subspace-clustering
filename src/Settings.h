...
//}       json, see temp folder of julius::    create a JSON file in this format




#ifndef PARTIALLY_OPTIMAL_SUBSPACE_CLUSTERING_SETTINGS_H
#define PARTIALLY_OPTIMAL_SUBSPACE_CLUSTERING_SETTINGS_H
...
#endif //PARTIALLY_OPTIMAL_SUBSPACE_CLUSTERING_SETTINGS_H
